...
namespace BfresLibrary
{
    ...
    public class Bone : IResData, INamed, INotifyPropertyChanged
    {
        ...
        {
            get { return FlagsTransform.HasFlag(BoneFlagsTransform.SegmentScaleCompensate); }
            set
            {
                if (value == true)
                    FlagsTransform |= BoneFlagsTransform.SegmentScaleCompensate;
                else
                    FlagsTransform &= ~BoneFlagsTransform.SegmentScaleCompensate;
            }
        }
    ...
    public enum BoneFlagsTransform : uint
    {
        None,
        /// <summary>
        /// The bone does not inherit its parent's scale. Only the parent's scale applied to
        /// this bone's translation survives.
        /// </summary>
