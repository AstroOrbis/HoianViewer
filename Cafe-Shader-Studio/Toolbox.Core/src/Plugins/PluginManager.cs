    ...
    public class PluginManager
    {
        ...
        public static ICollection<PluginInstance> LoadPlugins(bool force = false)
        {
           ...
           // PluginList.Add(mainLibrary);
            ...
            //This assembly carries the built in formats. It is already loaded, so use it
            //directly instead of reading Toolbox.Core.dll back off disk, which forces a loose
            //copy to ship beside the exe and throws outright under a single file publish.
            loadedLibs.Add("Toolbox.Core.dll");

            ICollection<Assembly> assemblies = new List<Assembly>(dllFileNames.Count + 1);
